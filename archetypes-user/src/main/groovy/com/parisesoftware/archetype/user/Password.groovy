...
class Password {
     ...
     * @throws IllegalArgumentException when there is a validation issue found with the given value
     */
    static Password of(final String value) throws IllegalArgumentException {
